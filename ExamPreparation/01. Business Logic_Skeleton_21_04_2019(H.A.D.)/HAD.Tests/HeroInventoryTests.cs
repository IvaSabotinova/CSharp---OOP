...
namespace HAD.Tests
{
    ...
    public class HeroInventoryTests
    {
        ...
        public void Setup()
        {
            ...
            List<string> recipe1 = new List<string>() { "aaa" };
            List<string> recipe2 = new List<string>() { "bbb" };
            recipeitem1 = new RecipeItem("aaa11", 15, 15, 30, 30, 30, recipe1);
            recipeitem2 = new RecipeItem("bbb11", 7, 9, 9, 35, 35, recipe2);

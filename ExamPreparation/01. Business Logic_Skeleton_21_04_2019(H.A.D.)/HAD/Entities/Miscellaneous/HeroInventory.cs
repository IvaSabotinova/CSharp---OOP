    ...
    public class HeroInventory : IInventory
    {
        ...
        private void CheckRecipes()
        {
            foreach (IRecipe recipe in this.recipeItems.Values)
            {
                ...
                foreach (IItem item in this.commonItems.Values)
                {
        ...
        private void CombineRecipe(IRecipe recipe)
        {
            ...
            IItem newItem = new CommonItem(recipe.Name, recipe.StrengthBonus, recipe.AgilityBonus, recipe.IntelligenceBonus, recipe.HitPointsBonus, recipe.DamageBonus);

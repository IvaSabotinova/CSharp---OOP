namespace HAD.Entities.Heroes
{
    public class Barbarian : BaseHero
    {
        ...
        public Barbarian(string name) : base(name, BaseStrengthHeroStrength, BaseStrengthHeroAgility, BaseStrengthHeroIntelligence, BaseStrengthHeroHitPoints, BaseStrengthHeroDamage)
        {
        }
    }
}